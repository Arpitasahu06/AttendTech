...
const SCHEDULE = [
{ id: 1, day: 'Monday', start: 9, end: 10, subject: 'Data Structures', classId: 'CSE 3A', room: 'Lab 101' },
{ id: 2, day: 'Monday', start: 11, end: 12, subject: 'Algorithms', classId: 'CSE 5A', room: 'Room 204' },
{ id: 3, day: 'Monday', start: 14, end: 15, subject: 'Operating Systems', classId: 'CSE 3B', room: 'Room 105' },
{ id: 4, day: 'Tuesday', start: 10, end: 11, subject: 'Data Structures', classId: 'CSE 3B', room: 'Lab 101' },
{ id: 5, day: 'Tuesday', start: 12, end: 13, subject: 'Database Management', classId: 'IT 3A', room: 'Room 301' },
{ id: 6, day: 'Wednesday', start: 9, end: 10, subject: 'Data Structures', classId: 'CSE 3A', room: 'Lab 101' },
{ id: 7, day: 'Wednesday', start: 11, end: 12, subject: 'Algorithms', classId: 'CSE 3A', room: 'Room 105' },
{ id: 8, day: 'Wednesday', start: 14, end: 15, subject: 'Computer Networks', classId: 'CSE 5A', room: 'Room 204' },
{ id: 9, day: 'Thursday', start: 10, end: 11, subject: 'Operating Systems', classId: 'CSE 5A', room: 'Room 204' },
{ id: 10, day: 'Thursday', start: 14, end: 15, subject: 'Database Management', classId: 'CSE 3B', room: 'Room 301' },
{ id: 11, day: 'Friday', start: 9, end: 10, subject: 'Data Structures', classId: 'IT 3A', room: 'Lab 101' },
{ id: 12, day: 'Friday', start: 11, end: 12, subject: 'Computer Networks', classId: 'CSE 3A', room: 'Room 105' },
];
...
return ( <div className="schedule-page">
  ...
  <div className="stats-row">
    ...
    <div className="stat-box">
      <h3>{[...new Set(SCHEDULE.map(i => i.subject))].length}</h3>
      <p>Subjects</p>
    </div>

    <div className="stat-box">
      <h3>{todayclass.length}</h3>
      <p>Today's classes</p>
    </div>
  </div>
  ...
  {todayname === 'Sunday' || todayname === 'Saturday'
    ...
    : todayclass.map(item => (
        <div key={item.id} className="today-card">
          <h3>{item.subject}</h3>
          <p>
            {item.start}:00 - {item.end}:00 • {item.classId} • {item.room}
          </p>
        </div>
      ))
  }
  ...
  {/* SELECT */}
  <select value={selectedschedule} onChange={(e) => setschedule(e.target.value)}>
    {workingDays.map(day => (
      <option key={day} value={day}>{day}</option>
    ))}
  </select>
